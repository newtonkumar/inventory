            ...
            <div className="relative z-10 flex h-full flex-col p-8">
                ...
                <div className="flex h-full flex-col justify-center">
                    <div className="max-w-md text-white">
                        <h1 className="mb-6 text-4xl font-bold">Online Inventory Management</h1>
                ...
                <div className="mt-auto">
                    <div className="text-sm text-white/70">© {new Date().getFullYear()} New Inventory. All rights reserved.</div>
                </div>
            </div>
        </div>
    );
